...
| `Z_MIN_PROBE_PIN` | comentado (`32`) | `32` | `PE7` | BLTouch no E1_DIAG, preservando o endstop físico no Z_MIN |
...
| `ad20773ead` | Redefinição inicial do `Z_MIN_PROBE_PIN` para `PC4` no conector Z_MAX, mantendo o BLTouch separado do endstop físico de Z |
...
| Sinal do BLTouch | `32` | `PE7` (E1_DIAG) |
